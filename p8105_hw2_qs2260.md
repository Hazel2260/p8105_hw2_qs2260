...
```
    ...
    ## 10  1947 November       24      51     253      23      45     198 Democrat 
    ## # … with 812 more rows
...
```
    ...
    ## 10  1947 November       24      51     253      23      45     198 Democr…    NA
    ## # … with 1,634 more rows, 1 more variable: unemploy_perc <dbl>, and abbreviated
...
gov_gop: the number of republican governors with associated time.
sen_gop: the number of republican senators with associated time.
rep_gop: the number of republican representatives with associated time.
gov_dem: the number of democratic governors with associated time.
sen_dem: the number of democratic senators with associated time.
rep_dem: the number of democratic representatives with associated time.
president: indicate the party of president with associated time. close:
the closing value of stock index. unemploy_perc: the unemployment
percentage with associated time.
